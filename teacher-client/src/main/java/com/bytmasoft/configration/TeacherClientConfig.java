...
import com.bytmasoft.TeacherClient;

/**
 * @author Mahamat Abakar created on 18.11.2020 at 00:02:10
 */
@Configuration
public class TeacherClientConfig {

	private String url = "http://localhost:8085/um/api/v1/";
//	private String url = "student-service/um/api/v1/";

	@Bean
	public TeacherClient teacherClient(WebClient webClient) {
		return new TeacherClient(webClient);
	}
