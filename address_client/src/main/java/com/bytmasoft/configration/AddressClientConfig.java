...
import com.bytmasoft.AddressClient;
...
public class AddressClientConfig {
	...
	private String url = "http://localhost:8083/um/api/v1/";
//	private String url = "student-service/um/api/v1/";

	@Bean
	public AddressClient addressClient(WebClient webClient) {
		return new AddressClient(webClient);
	}
