...
import com.bytmasoft.ManagerClient;
...
public class ManagerClientConfig {
	...
	private String url = "http://localhost:8089/um/api/v1/";
//	private String url = "student-service/um/api/v1/";

	@Bean
	public ManagerClient mangerClient(WebClient webClient) {
		return new ManagerClient(webClient);
	}
