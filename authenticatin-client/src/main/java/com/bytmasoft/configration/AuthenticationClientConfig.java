...
import com.bytmasoft.AuthenticationClient;
...
public class AuthenticationClientConfig {
	...
	private String url = "http://localhost:8081/um/api/v1/";
//	private String url = "student-service/um/api/v1/";

	@Bean
	public AuthenticationClient authClient(WebClient webClient) {
		return new AuthenticationClient(webClient);
	}
