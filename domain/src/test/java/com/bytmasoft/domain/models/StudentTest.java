...
class StudentTest {
	 ...
	 * {@link com.bytmasoft.domain.models.Student#generateLoginname()}.
	 */
	@Test
	void testGenerateUsername() {
		s1.generateLoginname();
		assertEquals(s1.getLoginname(), "STABAKAM19");

		s2.generateLoginname();
		assertNotEquals(s2.getLoginname(), "STABAKAM05");
	...
	void testSetUsername() {
		...
		s1.setLoginname("STABAKAM05");
		assertEquals(s1.getLoginname(), "STABAKAM05");
	}
